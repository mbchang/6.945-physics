...
representation. For example, though the examples in this paper concern 2-dimensional worlds for easy graphic display, the physics can easily be extended to 3-dimensinoal worlds and beyond. The default velocity of an object is set to 0 if it is not
